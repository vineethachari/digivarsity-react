...
export default function DegreeResults() {
  return (
    <>
      <div className="px-4 mx-auto">
        <div className="grid grid-flow-row auto-rows-max gap-y-3">
          <h2 className="text-base not-italic font-semibold text-fun-blue mb-3">
            Degree Results
          </h2>
        </div>
        <div className="grid grid-cols-2 gap-x-3">
          <div className="block max-w-sm bg-light-fun-blue border-b-2 border-fun-blue">
            <div className="p-3.5">
          ...
          <nav aria-label="Page navigation example">
            <ul className="list-style-none flex">
              ...
              <li aria-current="page">
                <a
                  className="relative block rounded-full bg-light-fun-blue py-1.5 px-3 text-sm font-medium text-fun-blue transition-all duration-300"
                  href="#!"
                >
                  2
