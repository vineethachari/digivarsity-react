    ...
    <>
      <div className="px-4 mx-auto">
        <div className="grid grid-flow-row auto-rows-max gap-y-3">
          <h2 className="text-base not-italic font-semibold text-grey-teal mb-3">
            Opportunity Results
          </h2>
        </div>
        <div className="grid grid-cols-2 gap-x-3">
          <div className="block max-w-sm bg-light-grey-teal border-b-2 border-grey-teal">
            <div className="p-3.5">
          ...
          <nav aria-label="Page navigation example">
            <ul className="list-style-none flex">
              ...
              <li aria-current="page">
                <a
                  className="relative block rounded-full bg-light-grey-teal py-1.5 px-3 text-sm font-medium text-grey-teal transition-all duration-300"
                  href="#!"
                >
                  2
